...
export const InstagramIcon = ({ className, ...rest }) => {
  return (
    ...
    >
      <path
        fill="#E1306C"
        d="M34.75 4H13.25A9.257 9.257 0 0 0 4 13.25v21.5A9.257 9.257 0 0 0 13.25 44h21.5A9.257 9.257 0 0 0 44 34.75V13.25A9.257 9.257 0 0 0 34.75 4zm6.25 30.75c0 3.45-2.8 6.25-6.25 6.25h-21.5c-3.45 0-6.25-2.8-6.25-6.25V13.25c0-3.45 2.8-6.25 6.25-6.25h21.5c3.45 0 6.25 2.8 6.25 6.25v21.5z"
      />
      <path
        fill="#E1306C"
        d="M24 14.3A9.71 9.71 0 0 0 14.3 24c0 5.35 4.35 9.7 9.7 9.7s9.7-4.35 9.7-9.7-4.35-9.7-9.7-9.7zm0 16.05c-3.5 0-6.35-2.85-6.35-6.35S20.5 17.65 24 17.65s6.35 2.85 6.35 6.35S27.5 30.35 24 30.35zM35.5 14.05c-1.25 0-2.25-1-2.25-2.25s1-2.25 2.25-2.25 2.25 1 2.25 2.25-1 2.25-2.25 2.25z"
      />
    </svg>
  );
};